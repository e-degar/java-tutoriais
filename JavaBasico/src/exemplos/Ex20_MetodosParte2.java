...
public class Ex20_MetodosParte2 {
	public static void main (String[]args) {
		...
		// Exemplo 1
		 ...
		 // Aqui eu to chamando dois métodos passando, respectivamente, os valores do vetor
		 // de de x. Os métodos basicamente vão imprimir esses valores lá dentro. Até aí nada demais.
		...
		// Vamos imprimir os valores aqui no método mains pra ver o comportamento.
		 ...
		 * uma nova variada é criada nesse método pra receber esse valor. Ela é alocada em outro lugar na
